...
def train(run_name, start_epoch, stop_epoch, img_w):
    ...
    # fdir = os.path.dirname("/home/ml/PycharmProjects/keras-image-ocr-master/wordlists.tgz")


    fdir = os.path.dirname(
        get_file('wordlists.tgz',
                 # origin='/home/ml/PycharmProjects/keras-image-ocr-master/wordlists.zip',
